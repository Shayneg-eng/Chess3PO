...
def findBestNextMoveForPlayer():
    ...
    for legalPlayerMove in findLeagalMoves():
        board.push_san(legalPlayerMove.strip()) # make the first legal move
        
        # get all response moves to that move
        ...
        # find the most dangerous response
...
def game():
    ...
    while True:
        ...
        startTime = time.time()
        BOTmove = findBestNextMoveForPlayer()
